...
#define AFF_REG_KEYv_MAX_LINK_ERROR			"MaxLinkError"
...
/*******************************************/
#define AFF_ERI_FICHIER_TRACES  "AFF_ERI"
...
typedef struct
{
   ...
   noyau_chrono_id            uiChronoDelayCmd;
   BOOL						  bChronoDelayCmdstarted;
   noyau_delai                dwDelayCmdTimeout;
}
struct_globale_aff;
