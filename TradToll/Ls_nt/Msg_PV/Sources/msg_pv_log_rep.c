...
#define MSG_PV_LOG_REP_NB_FIELDS MSG_PV_HEADER_NB_FIELDS + 5 + 1
...
MSG_DECLARE_REF (MSG_PV_LOG_REP, MSG_PV_LOG_REP_NB_FIELDS)
...
PROTECTED void MSG_PV_LOG_REP_Init(void)
{
    ...
    union MSG_Field LOCAL_MSG_PV_LOG_REP[MSG_PV_LOG_REP_NB_FIELDS] =  
    {
        { MSG_FIELD_PV_HEADER (MSG_PV_LOG_REP, MSG_PV_LOG_REP_CD) },
		
		{ MSG_FIELD_VARSTR,  MSG_OFFSET(MSG_PV_LOG_REP, body.name),       0UL,           MSG_PV_MAX_USER_NAME - 1UL },
		{ MSG_FIELD_VARSTR,  MSG_OFFSET(MSG_PV_LOG_REP, body.firstname),  0UL,           MSG_PV_MAX_USER_FIRSTNAME - 1UL },
        { MSG_FIELD_DWORD,   MSG_OFFSET(MSG_PV_LOG_REP, body.matricule),  0UL,           999999UL },
		{ MSG_FIELD_VARSTR,  MSG_OFFSET(MSG_PV_LOG_REP, body.profilename),0UL,           MSG_PV_MAX_USER_PROFILE_NAME - 1UL },		
		{ MSG_FIELD_STRING,  MSG_OFFSET(MSG_PV_LOG_REP, body.reply),      0UL,           MSG_PV_MAX_USER_REPLY - 1UL },
    ...
    MSG_INIT_REF (MSG_PV_LOG_REP,                    LOCAL_MSG_PV_LOG_REP);
}
...
PUBLIC struct MSG_PV_LOG_REP *MSG_PV_LOG_REP_New (void)
{
    // la variable MSG_PV_LOG_REP de type union MSG_Field[] est globale au module 
    // et a ete declare et initialise par les macros MSG_DECLARE_REF et MSG_INIT_REF
    return MSG_New (MSG_PV_LOG_REP, sizeof(struct MSG_PV_LOG_REP), "MSG_PV_LOG_REP");
}
...
PUBLIC BOOL MSG_PV_LOG_REP_Delete_All (struct MSG_PV_LOG_REP *p_ptr)
{
...
// passe a la moulinette une structure de donnée "struct MSG_PV_LOG_REP"
// a travers des parcours récursif des tableaux de description des champs
// de type union MSG_Field[] (cf variable MSG_PV_LOG_REP de MSG_PV_LOG_REP_New
// et MSG_PV_LOG_REP_Init)
// La variable p_msg contient en retour le mesasge sous forme ASCII
PUBLIC BOOL MSG_PV_LOG_REP_Write (struct MSG_PV_LOG_REP *p_ptr, 
                               BYTE *p_msg, 
                               DWORD msg_size_max, 
...
// de type struct MSG_PV_LOG_REP
PUBLIC BOOL MSG_PV_LOG_REP_Read (struct MSG_PV_LOG_REP *p_ptr, 
                              BYTE *p_msg, 
                              DWORD msg_size_max, 
                              DWORD *final_msg_size)
{
...
PUBLIC BOOL MSG_PV_LOG_REP_New_Record (HLIST *hList)
{
    return MSG_New_Record (hList, 
                          (MSG_Compare) MSG_PV_HEADER_Compare_CD, 
                          (PVOID) MSG_PV_LOG_REP_CD, 
                          MSG_PV_LOG_REP, 
                          sizeof(struct MSG_PV_LOG_REP),
						  "MSG_PV_LOG_REP");
}
