...
PRIVATE void CmdExecutePrompt( ACOM_CNX_HANDLE hCnx )
{
    ...
    CmdResponse( hCnx, "PROMPTITEM TITLE    : %s", EXTFILESSVC_PROMPT_TITLE );
    CmdResponse( hCnx, "PROMPTITEM VERSION  : %s", EXTFILESSVC_PROMPT_VERSION );
    CmdResponse( hCnx, "PROMPTITEM DATE     : %s", EXTFILESSVC_PROMPT_DATE );
    CmdResponse( hCnx, "PROMPTITEM COMMENTS : %s", EXTFILESSVC_PROMPT_COMMENTS );
...
PRIVATE void CmdExecuteStatus( ACOM_CNX_HANDLE hCnx )
{
    ...
    CmdResponse( hCnx, "STATUSITEM DATABASE,%s", gsSvcWork.bDatabaseMissing ? "Offline" : "Online" );
