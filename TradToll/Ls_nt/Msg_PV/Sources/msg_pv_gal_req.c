...
#define MSG_PV_GAL_REQ_NB_FIELDS MSG_PV_HEADER_NB_FIELDS + 1
...
MSG_DECLARE_REF (MSG_PV_GAL_REQ, MSG_PV_GAL_REQ_NB_FIELDS)
...
{ 
    ...
    union MSG_Field LOCAL_MSG_PV_GAL_REQ[MSG_PV_GAL_REQ_NB_FIELDS] =  
    {
        { MSG_FIELD_PV_HEADER (MSG_PV_GAL_REQ, MSG_PV_GAL_REQ_CD) },
    ...
    MSG_INIT_REF (MSG_PV_GAL_REQ,                    LOCAL_MSG_PV_GAL_REQ);
}
...
PUBLIC struct MSG_PV_GAL_REQ *MSG_PV_GAL_REQ_New (void)
{
    // la variable MSG_PV_GAL_REQ de type union MSG_Field[] est globale au module 
    // et a ete declare et initialise par les macros MSG_DECLARE_REF et MSG_INIT_REF
    return MSG_New (MSG_PV_GAL_REQ, sizeof(struct MSG_PV_GAL_REQ), "MSG_PV_GAL_REQ");
}
...
PUBLIC BOOL MSG_PV_GAL_REQ_Delete_All (struct MSG_PV_GAL_REQ *p_ptr)
{
...
// passe a la moulinette une structure de donnée "struct MSG_PV_GAL_REQ"
// a travers des parcours récursif des tableaux de description des champs
// de type union MSG_Field[] (cf variable MSG_PV_GAL_REQ de MSG_PV_GAL_REQ_New
// et MSG_PV_GAL_REQ_Init)
// La variable p_msg contient en retour le mesasge sous forme ASCII
PUBLIC BOOL MSG_PV_GAL_REQ_Write (struct MSG_PV_GAL_REQ *p_ptr, 
                               BYTE *p_msg, 
                               DWORD msg_size_max, 
...
// de type struct MSG_PV_GAL_REQ
PUBLIC BOOL MSG_PV_GAL_REQ_Read (struct MSG_PV_GAL_REQ *p_ptr, 
                              BYTE *p_msg, 
                              DWORD msg_size_max, 
                              DWORD *final_msg_size)
{
...
PUBLIC BOOL MSG_PV_GAL_REQ_New_Record (HLIST *hList)
{
    return MSG_New_Record (hList, 
                          (MSG_Compare) MSG_PV_HEADER_Compare_CD, 
                          (PVOID) MSG_PV_GAL_REQ_CD, 
                          MSG_PV_GAL_REQ, 
                          sizeof(struct MSG_PV_GAL_REQ),
						  "MSG_PV_GAL_REQ");
}
