...
#define MSG_LC_AUTH_VT_ENL_REP_NB_FIELDS MSG_HEADER_NB_FIELDS + 11 + 1 //header + num of body elements + stop
...
MSG_DECLARE_REF(MSG_LC_AUTH_VT_ENL_REP, MSG_LC_AUTH_VT_ENL_REP_NB_FIELDS)
...
PROTECTED void MSG_LC_AUTH_VT_ENL_REP_Init(void)
{
    ...
    union MSG_Field LOCAL_MSG_LC_AUTH_VT_ENL_REP[MSG_LC_AUTH_VT_ENL_REP_NB_FIELDS] =  
    {
        { MSG_FIELD_HEADER (MSG_LC_AUTH_VT_ENL_REP, MSG_LC_AUTH_VT_ENL_REP_CD) },

		{ MSG_FIELD_TIME,	MSG_OFFSET(MSG_LC_AUTH_VT_ENL_REP, body.dte_ref_entry)																					},

		{ MSG_FIELD_DWORD,	MSG_OFFSET(MSG_LC_AUTH_VT_ENL_REP, body.entry_trs_ref_num),					0UL,			99999UL										},

		{ MSG_FIELD_DWORD,	MSG_OFFSET(MSG_LC_AUTH_VT_ENL_REP, body.entry_plaza_id),					0UL,			9999UL										},

		{ MSG_FIELD_DWORD,	MSG_OFFSET(MSG_LC_AUTH_VT_ENL_REP, body.entry_lane_id),						0UL,			9999UL										},

		{ MSG_FIELD_VARSTR, MSG_OFFSET(MSG_LC_AUTH_VT_ENL_REP, body.entry_trs_id ),						0UL,			MSG_LC_AUTH_VT_ENL_REP_TRS_ID_LENGTH		},

		{ MSG_FIELD_TIME,	MSG_OFFSET(MSG_LC_AUTH_VT_ENL_REP, body.dte_entry)																						},

		{ MSG_FIELD_VARSTR, MSG_OFFSET(MSG_LC_AUTH_VT_ENL_REP, body.entry_vrn ),						0UL,			MSG_LC_AUTH_VT_ENL_REP_VRN_LENGTH			},

		{ MSG_FIELD_VARSTR, MSG_OFFSET(MSG_LC_AUTH_VT_ENL_REP, body.entry_vrn_country ),				0UL,			MSG_LC_AUTH_VT_ENL_REP_VRN_COUNTRY_LENGTH	},

		{ MSG_FIELD_VARSTR, MSG_OFFSET(MSG_LC_AUTH_VT_ENL_REP, body.entry_provider ),					0UL,			MSG_LC_AUTH_VT_ENL_REP_PROVIDER_LENGTH		},

		{ MSG_FIELD_DWORD,	MSG_OFFSET(MSG_LC_AUTH_VT_ENL_REP, body.flag_result),						0UL,			9UL											},

		{ MSG_FIELD_DWORD,	MSG_OFFSET(MSG_LC_AUTH_VT_ENL_REP, body.reason_id),							0UL,			999999UL									},
    ...
    MSG_INIT_REF (MSG_LC_AUTH_VT_ENL_REP, LOCAL_MSG_LC_AUTH_VT_ENL_REP);
...
PUBLIC struct MSG_LC_AUTH_VT_ENL_REP *MSG_LC_AUTH_VT_ENL_REP_New (void)
{
    ...
    return MSG_New (MSG_LC_AUTH_VT_ENL_REP, sizeof(struct MSG_LC_AUTH_VT_ENL_REP), "MSG_LC_AUTH_VT_ENL_REP");
}
...
PUBLIC BOOL MSG_LC_AUTH_VT_ENL_REP_Delete_All (struct MSG_LC_AUTH_VT_ENL_REP *p_auth_vt_enl_rep)
{
...
PUBLIC BOOL MSG_LC_AUTH_VT_REP_ENL_Write (struct MSG_LC_AUTH_VT_ENL_REP *p_auth_vt_enl_rep, 
                               BYTE *p_msg, 
                               DWORD msg_size_max, 
...
PUBLIC BOOL MSG_LC_AUTH_VT_ENL_REP_Read (struct MSG_LC_AUTH_VT_ENL_REP *p_auth_vt_enl_rep, 
                              BYTE *p_msg, 
                              DWORD msg_size_max, 
                              DWORD *final_msg_size)
{
...
PUBLIC BOOL MSG_LC_AUTH_VT_ENL_REP_New_Record (HLIST *hList)
{
    return MSG_New_Record (hList, 
                          (MSG_Compare) MSG_HEADER_Compare_CD, 
                          (PVOID) MSG_LC_AUTH_VT_ENL_REP_CD, 
 			              MSG_LC_AUTH_VT_ENL_REP, 
                          sizeof(struct MSG_LC_AUTH_VT_ENL_REP), "MSG_LC_AUTH_VT_ENL_REP");
}
