												...
												OUT char profile_name[MSG_PV_MAX_USER_PROFILE_NAME])
{
	...
	*profile_id			= 0;
	...
	if (Auth.hDbCnx == NULL)
	{
		NTSVCInfo("CONF_PV_Get_User_Auth_Cmd() => Error: connection to database impossible!");
		return FALSE;
	}
	...
	do
	{
		...
		_snprintf_s(szStatement, 
					...
					sizeof(szStatement),
					"BEGIN PV.PV_DB_Get_User_Auth_Cmd( :Name_in, %d, :Password, %d, :Name_out, :Matricule, :FirstName, :UserOk, :ProfileId, :ProfileName ); END;", 
					matricule_in, 
					cmd_id);
		...
		if (Auth.hStat == NULL)
		{
			...
			NTSVCInfo("CONF_PV_Get_User_Auth_Cmd() => _DBOpenStatement(), Error: %u, %s", dwErr, szErr);
			break;
		}
		...
		{
			_DBGetLastError(Auth.hDbCnx, NULL, &dwErr, szErr, sizeof(szErr));
			NTSVCInfo("CONF_PV_Get_User_Auth_Cmd() => Error: %u, bind Name_in : %s", dwErr, szErr);
			break;
		}
		...
		{
			_DBGetLastError(Auth.hDbCnx, NULL, &dwErr, szErr, sizeof(szErr));
			NTSVCInfo("CONF_PV_Get_User_Auth_Cmd() => Error: %u, bind Password : %s", dwErr, szErr);
			break;
		}
		...
		{
			_DBGetLastError(Auth.hDbCnx, NULL, &dwErr, szErr, sizeof(szErr));
			NTSVCInfo("CONF_PV_Get_User_Auth_Cmd() => Error: %u, bind Name_out : %s", dwErr, szErr);
			break;
		}
		...
		{
			_DBGetLastError(Auth.hDbCnx, NULL, &dwErr, szErr, sizeof(szErr));
			NTSVCInfo("CONF_PV_Get_User_Auth_Cmd() => Error: %u, bind Matricule : %s", dwErr, szErr);
			break;
		}
		...
		{
			_DBGetLastError(Auth.hDbCnx, NULL, &dwErr, szErr, sizeof(szErr));
			NTSVCInfo("CONF_PV_Get_User_Auth_Cmd() => Error: %u, bind Firstname : %s", dwErr, szErr);
			break;
		}
		...
		{
			_DBGetLastError(Auth.hDbCnx, NULL, &dwErr, szErr, sizeof(szErr));
			NTSVCInfo("CONF_PV_Get_User_Auth_Cmd() => Error: %u, bind User_ok : %s", dwErr, szErr);
			break;
		}
		...
		{
			_DBGetLastError(Auth.hDbCnx, NULL, &dwErr, szErr, sizeof(szErr));
			NTSVCInfo("CONF_PV_Get_User_Auth_Cmd() => Error: %u, bind ProfileId : %s", dwErr, szErr);
			break;
		}
		...
		{
			_DBGetLastError(Auth.hDbCnx, NULL, &dwErr, szErr, sizeof(szErr));
			NTSVCInfo("CONF_PV_Get_User_Auth_Cmd() => Error: %u, bind ProfileName : %s", dwErr, szErr);
			break;
		}
		...
		{
			_DBGetLastError(Auth.hDbCnx, NULL, &dwErr, szErr, sizeof(szErr));
			NTSVCInfo("CONF_PV_Get_User_Auth_Cmd() => _DBExecuteStatement(), Error: %u, %s", dwErr, szErr);
			break;
		}
		...
		NTSVCInfo("CONF_PV_Get_User_Auth_Cmd(),  name = %s, matricule = %d, firstname = %s, userok = %d",
			name_out, *matricule_out, firstname, *user_ok);
	...
	if (Auth.hDbCnx != NULL)
	{
		// NTSVCInfo( "CONF_PV_Get_User_Auth_Cmd() => disconnect from database!" );
