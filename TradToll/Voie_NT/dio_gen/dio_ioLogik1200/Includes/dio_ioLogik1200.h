...
#ifndef DIO_IOLOGIK1200_H
#define DIO_IOLOGIK1200_H
...
#define DIO_IOLOGIK1200_REG_KEYn	"DIO_IOLOGIK1200\\"
...
{	
	...
	DWORD	dwSetInputModesToDI;	// set input modes to DI
	DWORD	dwSetOutputModesToDO;	// set output modes to DO
