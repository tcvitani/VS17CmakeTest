...
__declspec(dllexport) BOOL WINAPI CONF_PV_Get_First_Display(IN DWORD plazanum,
															OUT DWORD *disp_id);
...
__declspec(dllexport) BOOL WINAPI CONF_PLAZA_Get_First_Plaza(OUT DWORD *plaza_number, DWORD dwDefaultPlazaNumber);

__declspec(dllexport) BOOL WINAPI CONF_PLAZA_Get_Next_Plaza(OUT DWORD *plaza_number, DWORD dwDefaultPlazaNumber);

__declspec(dllexport) BOOL WINAPI CONF_PLAZA_Get_First_Lane(IN DWORD plazanum,
															OUT DWORD *lane_number);
