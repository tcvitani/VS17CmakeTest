...
#define MSG_PV_COM_REQ_NB_FIELDS MSG_PV_HEADER_NB_FIELDS + 5 + 1
#define MSG_PV_COM_REQ_LANENUM_NB_FIELDS 1 + 1
...
MSG_DECLARE_REF(MSG_PV_COM_REQ, MSG_PV_COM_REQ_NB_FIELDS)
MSG_DECLARE_REF(MSG_PV_COM_REQ_Lanenum, MSG_PV_COM_REQ_LANENUM_NB_FIELDS)
...
PROTECTED void MSG_PV_COM_REQ_Init(void)
{
    ...
    union MSG_Field LOCAL_MSG_PV_COM_REQ[MSG_PV_COM_REQ_NB_FIELDS] =  
    {
        { MSG_FIELD_PV_HEADER (MSG_PV_COM_REQ, MSG_PV_COM_REQ_CD) },

		{ MSG_FIELD_DWORD,	MSG_OFFSET(MSG_PV_COM_REQ, body.id),		0UL,	999UL },
        { MSG_FIELD_DWORD,	MSG_OFFSET(MSG_PV_COM_REQ, body.cd),		0UL,	999UL },
        { MSG_FIELD_DWORD,	MSG_OFFSET(MSG_PV_COM_REQ, body.size_of_command),		0UL,	MSG_PV_MAX_COMMAND_SIZE - 1UL },
		{ MSG_FIELD_RAW,	MSG_OFFSET(MSG_PV_COM_REQ, body.command),	MSG_OFFSET(MSG_PV_COM_REQ, body.size_of_command) },
        
		{ MSG_FIELD_LIST,	MSG_OFFSET(MSG_PV_COM_REQ, list_lanenum),	MSG_PV_COM_REQ_Lanenum, MSG_SIZEOF(MSG_PV_COM_REQ_Lanenum),	0UL, 99UL },
		
        { MSG_FIELD_STOP }
    };

    union MSG_Field LOCAL_LANENUM[MSG_PV_COM_REQ_LANENUM_NB_FIELDS] =  
    {
        { MSG_FIELD_DWORD,	MSG_OFFSET(MSG_PV_COM_REQ_Lanenum, lanenum),		0UL,    9999UL },
    ...
    MSG_INIT_REF (MSG_PV_COM_REQ,             LOCAL_MSG_PV_COM_REQ);
    MSG_INIT_REF (MSG_PV_COM_REQ_Lanenum,       LOCAL_LANENUM);
}
...
PUBLIC struct MSG_PV_COM_REQ *MSG_PV_COM_REQ_New (void)
{
    // la variable MSG_PV_COM_REQ de type union MSG_Field[] est globale au module 
    // et a ete declare et initialise par les macros MSG_DECLARE_REF et MSG_INIT_REF
    return MSG_New (MSG_PV_COM_REQ, sizeof(struct MSG_PV_COM_REQ), "MSG_PV_COM_REQ");
}

// constructeur d'un element de liste de type "lanenum"
// le pointeur de liste est normalement l'@ du champ "list_lanenum" d'un
// message de type "struct MSG_PV_COM_REQ" préalablement alloué par MSG_PV_COM_REQ_New
// rem : l'allocation du handle de liste est automatique
PUBLIC struct MSG_PV_COM_REQ_Lanenum *MSG_PV_COM_REQ_Lanenum_New (HLIST *list)
{
    // la variable MSG_PV_COM_REQ_Lanenum de type union MSG_Field[] est globale au module 
    // et a ete declare et initialise par les macros MSG_DECLARE_REF et MSG_INIT_REF
    return MSG_New_List (list, MSG_PV_COM_REQ_Lanenum, sizeof(struct MSG_PV_COM_REQ_Lanenum));
}
...
PUBLIC BOOL MSG_PV_COM_REQ_Delete_All (struct MSG_PV_COM_REQ *p_ptr)
{
...
PUBLIC struct MSG_PV_COM_REQ_Lanenum *MSG_PV_COM_REQ_Get_First_Lanenum (HLIST list)
{
    return MSG_Get_First (list);
}

PUBLIC struct MSG_PV_COM_REQ_Lanenum *MSG_PV_COM_REQ_Get_Next_Lanenum (HLIST list, struct MSG_PV_COM_REQ_Lanenum *p_ptr)
{
...
// passe a la moulinette une structure de donnée "struct MSG_PV_COM_REQ"
// a travers des parcours récursif des tableaux de description des champs
// de type union MSG_Field[] (cf variable MSG_PV_COM_REQ de MSG_PV_COM_REQ_New
// et MSG_PV_COM_REQ_Init)
// La variable p_msg contient en retour le mesasge sous forme ASCII
PUBLIC BOOL MSG_PV_COM_REQ_Write (struct MSG_PV_COM_REQ *p_ptr, 
                               BYTE *p_msg, 
                               DWORD msg_size_max, 
...
// de type struct MSG_PV_COM_REQ
PUBLIC BOOL MSG_PV_COM_REQ_Read (struct MSG_PV_COM_REQ *p_ptr, 
                              BYTE *p_msg, 
                              DWORD msg_size_max, 
                              DWORD *final_msg_size)
{
...
PUBLIC BOOL MSG_PV_COM_REQ_New_Record (HLIST *hList)
{
    return MSG_New_Record (hList, 
                          (MSG_Compare) MSG_PV_HEADER_Compare_CD, 
                          (PVOID) MSG_PV_COM_REQ_CD, 
                          MSG_PV_COM_REQ, 
                          sizeof(struct MSG_PV_COM_REQ),
						  "MSG_PV_COM_REQ");
}
