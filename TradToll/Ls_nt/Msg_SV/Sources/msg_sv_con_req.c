...
#define MSG_SV_CON_REQ_NB_FIELDS MSG_SV_HEADER_NB_FIELDS + 1
...
MSG_DECLARE_REF(MSG_SV_CON_REQ, MSG_SV_CON_REQ_NB_FIELDS)
...
PROTECTED void MSG_SV_CON_REQ_Init(void)
{
    ...
    union MSG_Field LOCAL_MSG_SV_CON_REQ[MSG_SV_CON_REQ_NB_FIELDS] =  
    {
        { MSG_FIELD_SV_HEADER (MSG_SV_CON_REQ, MSG_SV_CON_REQ_CD) },
    ...
    MSG_INIT_REF (MSG_SV_CON_REQ,            LOCAL_MSG_SV_CON_REQ);
}
...
PUBLIC struct MSG_SV_CON_REQ *MSG_SV_CON_REQ_New (void)
{
    // la variable MSG_SV_CON_REQ de type union MSG_Field[] est globale au module 
    // et a ete declare et initialise par les macros MSG_DECLARE_REF et MSG_INIT_REF
    return MSG_New (MSG_SV_CON_REQ, sizeof(struct MSG_SV_CON_REQ), "MSG_SV_CON_REQ");
}
...
PUBLIC BOOL MSG_SV_CON_REQ_Delete_All (struct MSG_SV_CON_REQ *p_ptr)
{
...
// passe a la moulinette une structure de donnée "struct MSG_SV_CON_REQ"
// a travers des parcours récursif des tableaux de description des champs
// de type union MSG_Field[] (cf variable MSG_SV_CON_REQ de MSG_SV_CON_REQ_New
// et MSG_SV_CON_REQ_Init)
// La variable p_msg contient en retour le mesasge sous forme ASCII
PUBLIC BOOL MSG_SV_CON_REQ_Write (struct MSG_SV_CON_REQ *p_ptr, 
                               BYTE *p_msg, 
                               DWORD msg_size_max, 
...
// de type struct MSG_SV_CON_REQ
PUBLIC BOOL MSG_SV_CON_REQ_Read (struct MSG_SV_CON_REQ *p_ptr, 
                              BYTE *p_msg, 
                              DWORD msg_size_max, 
                              DWORD *final_msg_size)
{
...
PUBLIC BOOL MSG_SV_CON_REQ_New_Record (HLIST *hList)
{
    return MSG_New_Record (hList, 
                          (MSG_Compare) MSG_SV_HEADER_Compare_CD, 
                          (PVOID) MSG_SV_CON_REQ_CD, 
                          MSG_SV_CON_REQ, 
                          sizeof(struct MSG_SV_CON_REQ),
						  "MSG_SV_CON_REQ");
}
