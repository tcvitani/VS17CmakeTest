...
/*                                                                           */
/* --------------------------------------------------------------------------*/
/* FILE:     MSG_LC_PERM_RQ_SEND_FILE.C										 */
/* LANGUAGE: C                                                               */
/* --------------------------------------------------------------------------*/
/* DESCRIPTION:                                                              */
/*             																 */
...
#define MSG_PERM_RQ_SEND_FILE_NB_FIELDS MSG_HEADER_NB_FIELDS + 2 
...
MSG_DECLARE_REF(MSG_PERM_RQ_SEND_FILE, MSG_PERM_RQ_SEND_FILE_NB_FIELDS)
...
PROTECTED void MSG_PERM_RQ_SEND_FILE_Init(void)
{
    ...
    union MSG_Field LOCAL_MSG_PERM_RQ_SEND_FILE[MSG_PERM_RQ_SEND_FILE_NB_FIELDS] =  
    {
		{ MSG_FIELD_HEADER(MSG_PERM_RQ_SEND_FILE, MSG_PERM_RQ_SEND_FILE_CD) },
    ...
    MSG_INIT_REF(MSG_PERM_RQ_SEND_FILE,							 LOCAL_MSG_PERM_RQ_SEND_FILE);
}
...
PUBLIC struct MSG_PERM_RQ_SEND_FILE *MSG_PERM_RQ_SEND_FILE_New(void)
{
    // la variable MSG_PERM_RQ_SEND_FILE de type union MSG_Field[] est globale au module 
    // et a ete declare et initialise par les macros MSG_DECLARE_REF et MSG_INIT_REF
    return MSG_New(MSG_PERM_RQ_SEND_FILE, sizeof(struct MSG_PERM_RQ_SEND_FILE), "MSG_PERM_RQ_SEND_FILE");
}
...
PUBLIC BOOL MSG_PERM_RQ_SEND_FILE_Delete_All(struct MSG_PERM_RQ_SEND_FILE *p_perm_rq_send_file)
{
...
// passe a la moulinette une structure de donnée "struct MSG_PERM_RQ_SEND_FILE"
// a travers des parcours récursif des tableaux de description des champs
// de type union MSG_Field[](cf variable MSG_PERM_RQ_SEND_FILE de MSG_PERM_RQ_SEND_FILE_New
// et MSG_PERM_RQ_SEND_FILE_Init)
// La variable p_msg contient en retour le mesasge sous forme ASCII
PUBLIC BOOL MSG_PERM_RQ_SEND_FILE_Write(struct MSG_PERM_RQ_SEND_FILE *p_perm_rq_send_file, 
                               BYTE *p_msg, 
                               DWORD msg_size_max, 
...
// de type struct MSG_PERM_RQ_SEND_FILE
PUBLIC BOOL MSG_PERM_RQ_SEND_FILE_Read(struct MSG_PERM_RQ_SEND_FILE *p_perm_rq_send_file, 
                              BYTE *p_msg, 
                              DWORD msg_size_max, 
                              DWORD *final_msg_size)
{
...
PUBLIC BOOL MSG_PERM_RQ_SEND_FILE_New_Record(HLIST *hList)
{
    return MSG_New_Record(hList, 
                         (MSG_Compare) MSG_HEADER_Compare_CD, 
                         (PVOID) MSG_PERM_RQ_SEND_FILE_CD, 
	                      MSG_PERM_RQ_SEND_FILE, 
                          sizeof(struct MSG_PERM_RQ_SEND_FILE), "MSG_PERM_RQ_SEND_FILE");
}
