...
#define MOD_REG_KEYv_BACKGROUND				"Background"
#define MOD_REG_KEYv_STOP_MAILBOX_TIMEOUT_MS "StopModuleReadMailboxTimeoutMs"
#define MOD_REG_KEYv_POLL_TIMEOUT_MS		"PollTimeoutMs"
#define MOD_REG_KEYv_MAX_LINK_ERROR			"MaxLinkError"

/*******************************************/
/*      Gestion du mode DEBUG/TRACES      */
/*******************************************/
#define AFF_NOM_FICHIER_TRACES  "AFF_NOM"
...
typedef struct
{
  ...
  struct_b_etat_aff old_b_etat;			/* Old etat */
...
typedef struct
{
   ...
   unsigned char			  ucLastQuestionNumber;		// Counter of messages from IOS to device. Specialized for NOMISMA display
