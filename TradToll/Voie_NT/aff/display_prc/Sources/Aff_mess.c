...
* --------------------------------------------------------------------
* HISTORIQUE:
* $Log:   T:/MODULO/VoieNt/Aff/AFF/SOURCES/Aff_mess.c_v  $
 * 
 *    Rev 1.3   Jul 19 2001 16:56:02   sbatiot
 *  
 * 
 *    Rev 1.2   Oct 06 2000 11:55:38   CL
 ...
 * 
 *    Rev 1.4   Dec 14 1999 16:59:02   nbl
 *  
 * 
...
*
  *    Rev 1.2   Feb 19 1999 18:53:22   afx
 *  
 * 
   ...
   switch(type)
   {
      ...
      case SRV_TYP_NOUVEL_ETAT : // envoie etat a tous les demandeurs du service
		 ...
		 {		  
               ...
               memcpy( &p_msg_emis.u.srv_etat.status, &AFF[ident_aff].gestion_peripherique.b_etat,
                       sizeof(struct_b_etat_aff));
