...
PROTECTED BOOL WINAPI CONF_ALARM_Ack (struct MSG_PV_ALAR_REP *p_alar)
{
    ...
    // si la liste des alarmes a acquitter est vide...
    if (List_IsEmpty (p_alar->list_event) == TRUE)
        return TRUE;
    ...
    {        
        ...
        // Associate variables        
        Ack.hPlaza = _DBBindPlaceHolderVariable(Ack.hStat, 
												":Plaza", 
												DB_TYPE_INT, 
												sizeof(DWORD), 
												List_GetCount (p_alar->list_event));
        ...
        Ack.hLane = _DBBindPlaceHolderVariable(Ack.hStat, 
											":Lane", 
											DB_TYPE_INT, 
											sizeof(DWORD), 
											List_GetCount (p_alar->list_event));
        ...
        Ack.hType = _DBBindPlaceHolderVariable(Ack.hStat, 
											":Type", 
											DB_TYPE_INT, 
											sizeof(DWORD), 
											List_GetCount (p_alar->list_event));
        ...
        Ack.hSubType = _DBBindPlaceHolderVariable(Ack.hStat, 
												":SubType", 
												DB_TYPE_INT, 
												sizeof(DWORD), 
												List_GetCount (p_alar->list_event));
        ...
        Ack.hEvent = _DBBindPlaceHolderVariable(Ack.hStat, 
												":Event", 
												DB_TYPE_INT, 
												sizeof(DWORD), 
												List_GetCount (p_alar->list_event));
        ...
        Ack.hAppDate = _DBBindPlaceHolderVariable(Ack.hStat, 
												":AppDate", 
												DB_TYPE_STR, 
												CONF_MAX_DATE, 
												List_GetCount (p_alar->list_event));
        ...
        Ack.hAckDate = _DBBindPlaceHolderVariable(Ack.hStat, 
												":AckDate", 
												DB_TYPE_STR, 
												CONF_MAX_DATE, 
												List_GetCount (p_alar->list_event));
        ...
        Ack.hMatricule = _DBBindPlaceHolderVariable(Ack.hStat, 
													":Matricule", 
													DB_TYPE_INT, 
													sizeof(DWORD), 
													List_GetCount (p_alar->list_event));
        ...
        // on remplit les tableaux a partir de la liste d'alarmes a acquitter
        ...
        while (p_event != NULL)
        {
            ...
            pvResult = _DBSetVariableItemValue(Ack.hAppDate, Ack.dwConfIndex, &Appdate, (DWORD)strlen(Appdate) + 1);
            if (pvResult != &Appdate)
            {
                _DBGetLastError(Ack.hDbCnx, NULL, &dwErr, szErr, sizeof(szErr));
            ...
            pvResult = _DBSetVariableItemValue(Ack.hAckDate, Ack.dwConfIndex, &Ackdate, (DWORD)strlen(Ackdate) + 1);
            if ( pvResult != &Ackdate )
            {
                _DBGetLastError(Ack.hDbCnx, NULL, &dwErr, szErr, sizeof(szErr));
